<div class="row">
         ...
         <div class="box-tools">
            ...
            <th style="width: 110px">Aksi</th>
               ...
               <?php
               $kueriKwitansi= mysqli_query($koneksi,"select * from cera_sales where sales_id_status=4 order by sales_id desc");
               while($kat=mysqli_fetch_array($kueriKwitansi)){
               ?>

                     <td><?php echo $kat['sales_kwitansi_no']; ?></td>
                     <td><?php echo $kat['sales_nama_client']; ?></td>                    
              ...
              <div class="modal-body">
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" id="namaClient" name="nama_client" placeholder="Nama Client" value="<?php echo $kat['sales_nama_client'];?>">
                      </div>
                    </div>
