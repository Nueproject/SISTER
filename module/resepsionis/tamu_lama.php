...
<div class="row">
  <div class="col-xs-12">
   ...
   <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#tambahTamuBaru_lama" data-whatever="@mdo">Tambah Tamu Baru</button>

   <div class="modal fade bd-example-modal-lg" id="tambahTamuBaru_lama" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
