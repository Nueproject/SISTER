  ...
  <div class="col-xs-12">
    <div class="box">
      <div class="box-header">
        ...
        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#tambahTamuBaruCari" data-whatever="@mdo">Tambah Tamu Baru</button>
   
<div class="modal fade bd-example-modal-lg" id="tambahTamuBaruCari" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      $offset = ($page*2);
      $dataTamuBaru = "select * from data_pelayanan dp join data_tamu dt on dp.id_tamu = dt.id_tamu join data_bidang db on dp.id_bidang = db.id_bidang join status s on dp.status = s.id_status join data_instansi di on dt.instansi = di.id_instansi join data_pegawai p on dp.id_pegawai = p.id_pegawai where nama_instansi like '%$nama%' or nama_tamu like '%$nama%' or kode_pelayanan like '%$nama%'";
            ...
            <td>
                ...
                <div class="btn-group">
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="javascript::void(0)" data-toggle="modal" data-target="#modalcari<?php echo $pro['id_pelayanan'];?>">Detail</a></li>
                    <li><a class="dropdown-item" href="javascript::void(0)" data-toggle="modal" data-target="#duplicatecari<?php echo $pro['id_pelayanan'];?>" >Duplicate</a></li>
                    <li><a class="dropdown-item" href="javascript::void(0)" data-toggle="modal" data-target="#editcari<?php echo $pro['id_pelayanan'];?>" >Edit</a></li>
                    <li><a class="dropdown-item" data-toggle="modal" data-target="#setascari<?php echo $pro['id_pelayanan'];?>" data-whatever="@mdo">Set as DiLayani</a></li>
 ...
 <!-- Modal -->
 <div class="modal fade" id="modalcari<?php echo $pro['id_pelayanan'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
...
<div class="modal fade" id="duplicatecari<?php echo $pro['id_pelayanan'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
...
<div class="modal fade" id="editcari<?php echo $pro['id_pelayanan'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content modal-lg">
      <form action="module/resepsionis/aksi_resepsionis.php" method="post">
      <div class="modal-header">
...
<div class="modal fade" id="setascari<?php echo $pro['id_pelayanan'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content modal-lg">
      <form action="module/resepsionis/aksi_resepsionis.php" method="post">
      <div class="modal-header">
