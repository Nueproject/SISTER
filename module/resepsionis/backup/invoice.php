<div class="row">
  <div class="col-xs-12">
    <div class="box">
      ...
      $myq = "select * from cera_sales where sales_id_status=3 order by sales_invoice_no desc";
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">                    
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="email" value="" name="gunaBayar" placeholder="Guna Membayar">
                        </div>  
                ...
                <!--- Products ---->
                  <div class="row">
                    ...
                    <div class="col-md-4">                    
                        ...
                        <div class="form-group">
                          <label for="inputEmail3" class="control-label">Telepon/HP</label>
                          <input type="text" class="form-control" id="alamat" value="<?php echo $pro['sales_telp_client'];?>" name="phone_client" placeholder="Telepon/HP">
                        </div>
