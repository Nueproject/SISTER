	...
	<body class="hold-transition skin-blue sidebar-mini">
		<div class="wrapper">
			...
			<aside class="main-sidebar">
				...
				<section class="sidebar">
					...
					<ul class="sidebar-menu">
						...
						<li>
							<a class="dropdown-item" href="kepegawaian.php?module=home"> <i class="fa fa-home"></i> <span>Home</span> </a>
						</li>
					
						
						<li>
							<a class="dropdown-item" href="kepegawaian.php?module=resepsionis"> <i class="fa fa-shopping-cart"></i> <span>Resepsionis</span> </a>
						</li>

						<li>
							<a class="dropdown-item" href="kepegawaian.php?module=setup"> <i class="fa fa-shopping-cart"></i> <span>Setup</span> </a>
						</li>

						<li>
							<a class="dropdown-item" href="kepegawaian.php?module=pegawai"> <i class="fa fa-shopping-cart"></i> <span>Data PNS</span> </a>
						</li>

						<li>
							<a class="dropdown-item" href="kepegawaian.php?module=telepon"> <i class="fa fa-shopping-cart"></i> <span>Telepon</span> </a>
						</li>
						
         	 			<li>
							<a class="dropdown-item" href="kepegawaian.php?module=laporan"> <i class="fa fa-male"></i> <span>Laporan</span> </a>
						</li>
						<li>
            ...
            if ($_GET['module'] == 'home') {
                ...
                include "module/pegawai/index_up.php";
